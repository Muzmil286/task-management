<template>
    ...
    <div class="mb-4 inline-flex w-full overflow-hidden rounded-lg bg-white shadow-md">
                ...
                <div class="-mx-3 px-4 py-2">
                    <div class="mx-3">
                        <span class="font-semibold text-blue-500">Update</span>
...
const props = defineProps({
    ...
    const form = useForm({
        ...
        ipAddress: props.project.ip_address,
        adminName: props.project.admin_name,
        adminEmail: props.project.admin_email,
        password: props.project.admin_password
